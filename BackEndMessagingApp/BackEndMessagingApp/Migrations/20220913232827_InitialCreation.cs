    ...
    public partial class InitialCreation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPerConversations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserPerConversations_Conversations_ConversationId",
                        column: x => x.ConversationId,
                        principalTable: "Conversations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessageReactionPerUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MessageReactionPerUsers_Messages_MessageId",
                        column: x => x.MessageId,
                        principalTable: "Messages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MessageReactionPerUsers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageReactionPerUsers_MessageId",
                table: "MessageReactionPerUsers",
                column: "MessageId");

            migrationBuilder.CreateIndex(
                name: "IX_MessageReactionPerUsers_UserId",
                table: "MessageReactionPerUsers",
                column: "UserId");
